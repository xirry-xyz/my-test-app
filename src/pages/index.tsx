        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    <h3 className="text-slate-500 text-sm font-medium mb-2">库存总数</h3>
                    <p className="text-3xl font-bold text-slate-900">128</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    <h3 className="text-slate-500 text-sm font-medium mb-2">急需补货</h3>
                    <p className="text-3xl font-bold text-red-500">3</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    <h3 className="text-slate-500 text-sm font-medium mb-2">本月消耗</h3>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                <p className="text-slate-500">库存列表将在这里显示...</p>
            </div>
        </div>
    );
};
...
export const ShoppingList: React.FC = () => {
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-slate-800">购物清单</h2>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                <p className="text-slate-500">购物清单将在这里显示...</p>
            </div>
        </div>
    );
};
...
export const Stats: React.FC = () => {
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                <p className="text-slate-500">统计图表将在这里显示...</p>
            </div>
        </div>
    );
};
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center space-y-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">欢迎使用 HomeStock</h1>
                    <p className="text-slate-500 mt-2">您的智能家庭日用管家</p>
                </div>
                <button
                    onClick={handleLogin}
                    className="w-full bg-white border border-slate-200 text-slate-700 font-medium py-3 px-4 rounded-xl hover:bg-slate-50 transition-colors flex items-center justify-center gap-3"
                >
